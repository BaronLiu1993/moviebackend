...
import { handleSignIn, registerUser, } from "../../service/auth/authService.js";
...
router.get("/oauth2callback", async (req, res) => {
    ...
    try {
        const { data: tokenData, error: tokenDataError } = await supabase.auth.exchangeCodeForSession(code);
