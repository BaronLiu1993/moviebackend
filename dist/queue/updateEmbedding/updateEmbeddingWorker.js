...
const worker = new Worker("embedding-sync", async (job) => {
    ...
    console.log(`[EmbeddingWorker] Done: ${operation} user=${userId} count=${result.rating_count} weight=${result.behavioral_weight_sum}`);
...
//# sourceMappingURL=updateEmbeddingWorker.js.map